  ...
  return (
    <>
        ...
        <div className='work-images'>
          <img src={`${import.meta.env.BASE_URL}picture/vacancy.jpg`} alt=""/>
          <img src={`${import.meta.env.BASE_URL}picture/vacancy1.jpg`} alt=""/>
          <img src={`${import.meta.env.BASE_URL}picture/vacancy2.jpg`} alt=""/>
          <img src={`${import.meta.env.BASE_URL}picture/vacancy3.jpg`} alt=""/>
        </div>
